...
function ProfileCard() {
  ...
  if (loading) {
    return (
      <div className="card widget">
        <div className="card-content">Loading profile...</div>
      </div>
    );
  }
          ...
          <div className="card-content">
            ...
            <div>
              ...
              >
                ...
                {quote.from && (
                  <div className="has-text-right">— From《{quote.from}》</div>
                )}
                {quote.author && (
                  <div className="has-text-right">Provider: {quote.author}</div>
                )}
              </span>
            </div>
          </div>
